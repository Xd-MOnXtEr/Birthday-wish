    ...
    <div className="max-w-6xl mx-auto py-32 px-6">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
        <div className="space-y-8 order-2 md:order-1">
          ...
          <div className="space-y-6 text-lg text-slate-600 font-serif-title italic leading-relaxed">
            <p className="p-6 bg-white/40 rounded-3xl border-l-4 border-pink-400">
              "I see a future where your innocence continues to be our lighthouse. Where we grow old but our hearts stay as playful as that May morning in 2018."
            </p>
            <p className="p-6 bg-white/40 rounded-3xl border-l-4 border-rose-400">
              "A future where we build a home filled with the same 'sanskari' grace you carry today. A place where every wall echoes with your laughter."
            </p>
            <p className="p-6 bg-white/40 rounded-3xl border-l-4 border-pink-300">
              "Whatever the world throws at us, I promise to protect the purity of your soul. You are my forever, and forever is just the beginning."
            </p>
          </div>
        </div>
        ...
        <div className="relative order-1 md:order-2">
           ...
           {/* Removed aspect-square and object-cover to prevent any cropping of the image */}

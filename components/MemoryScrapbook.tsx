  ...
  return (
    <div className="max-w-6xl mx-auto py-32 px-6">
      <div className="text-center mb-24">
        <h2 className="text-5xl md:text-7xl font-romantic text-pink-600 mb-4">Captured Elegance</h2>
        <p className="text-gray-400 text-xs font-bold tracking-[0.6em] uppercase italic">Uncropped & Unforgettable</p>
      ...
      <div className="space-y-48">
        {newPhotos.map((photo, idx) => (
          ...
          >
            {/* Image Container - Using h-auto to ensure NO cropping */}
            ...
            <div className="w-full md:w-1/2 space-y-8 animate__animated animate__fadeIn">
              ...
              <p className="text-xl text-gray-600 leading-relaxed italic font-light font-serif-title">
                {idx === 0 && "In this capture, your essence speaks louder than words. It's the way your 'sanskari' upbringing reflects in your silent confidence—a beauty that doesn't need to shout to be heard."}
                {idx === 1 && "There's a light in your eyes that seems to come from a place of pure innocence. It’s the rarest kind of glow, one that warms everyone it touches."}
                {idx === 2 && "This moment captures the perfect peace you bring into my life. Your purity isn't just a trait; it's the very foundation of why I love you more every single day."}
              </p>
              <div className="pt-6 border-t border-pink-50 flex items-center gap-4">
                 <div className="text-pink-500 font-romantic text-2xl">Always yours, forever.</div>
              </div>
            </div>
          </div>
        ))}
